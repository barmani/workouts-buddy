...
/**
 * Replace an exercise in the current workout with a random exercise of the
 * same muscle group.
 */
exports.swapExercise = function(req, res, next) {
...
/**
 * Create a new workout from the form.
 */
exports.createWorkoutFromForm = function(req, res, next) {
